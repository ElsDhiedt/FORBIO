...
```{r}
data_2018 <- data_2018 %>%
  mutate(litter_dryweight_g_m2 = litter$biomass_g_m2[match(Plot_ID_upper, veg$plot_unique)])
```
...
#export data
write.csv(data_final, paste0(data_path, "C_data_for_Elina.csv"))
